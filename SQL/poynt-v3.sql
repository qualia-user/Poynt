...
-- Business table naming conventions
-- Tables: <business_id>_<base_table>
-- Indexes: <business_id>_<base_table>_<col>_idx
-- Sequences and IDENTITY columns should start at 1 per business.
-- Default business table collation: en_US.utf8; character set: UTF8.
